...
export class MemStorage implements IStorage {
    ...
    const samples: Omit<Permit, 'id' | 'createdAt'>[] = [
      {
        ...
        machineNumber: null, requestorPhone: null, serviceOrderNumber: null, procedureName: null,
        customerFab: null, machineType: null, customerNotified: null, customerContactName: null,
        customerContactPhone: null, activityDurationHours: null, expectedStartDate: null,
        expectedStartTime: null, expectedEndDate: null, expectedEndTime: null, multipleShifts: null,
        attendants: null, entrants: null, atmosphericTester: null, extractionPlanReviewed: null,
        ertContactInfo: null, spaceIdentification: null, communicationMethod: null,
        physicalHazards: null, atmosphericHazards: null, toolsChecklist: null,
        extractionSituations: null, extractionMethods: null, extractionEquipment: null,
        medicalEquipment: null, enhancedSignOff: null,
      },
      {
  ...
  async createPermit(permit: InsertPermit): Promise<Permit> {
    ...
    const p: Permit = {
      ...
      requestorPhone: permit.requestorPhone ?? null,
      serviceOrderNumber: permit.serviceOrderNumber ?? null,
      procedureName: permit.procedureName ?? null,
      customerFab: permit.customerFab ?? null,
      machineType: permit.machineType ?? null,
      machineNumber: permit.machineNumber ?? null,
      customerNotified: permit.customerNotified ?? null,
      customerContactName: permit.customerContactName ?? null,
      customerContactPhone: permit.customerContactPhone ?? null,
      activityDurationHours: permit.activityDurationHours ?? null,
      expectedStartDate: permit.expectedStartDate ?? null,
      expectedStartTime: permit.expectedStartTime ?? null,
      expectedEndDate: permit.expectedEndDate ?? null,
      expectedEndTime: permit.expectedEndTime ?? null,
      multipleShifts: permit.multipleShifts ?? null,
      // NEW: Confined Space — Personnel
      attendants: permit.attendants ?? null,
      entrants: permit.entrants ?? null,
      atmosphericTester: permit.atmosphericTester ?? null,
      extractionPlanReviewed: permit.extractionPlanReviewed ?? null,
      ertContactInfo: permit.ertContactInfo ?? null,
      // NEW: Confined Space — JSONB
      spaceIdentification: permit.spaceIdentification ?? null,
      communicationMethod: permit.communicationMethod ?? null,
      physicalHazards: permit.physicalHazards ?? null,
      atmosphericHazards: permit.atmosphericHazards ?? null,
      toolsChecklist: permit.toolsChecklist ?? null,
      extractionSituations: permit.extractionSituations ?? null,
      extractionMethods: permit.extractionMethods ?? null,
      extractionEquipment: permit.extractionEquipment ?? null,
      medicalEquipment: permit.medicalEquipment ?? null,
      enhancedSignOff: permit.enhancedSignOff ?? null,
      createdAt: new Date(),
    };
